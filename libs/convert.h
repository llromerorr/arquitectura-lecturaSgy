/******************************************************************************************************************************************************************************
*    To convert EBCDIC values to ASCII                                                                                                                                        *
*    and ASCII to EBCDIC.                                                                                                                                                     *  
*                                                                                                                                                                             *
*    Ref: http://www8.cs.umu.se/~isak/Snippets/a2e.c                                                                                                                          *
*         https://www.ibm.com/support/knowledgecenter/en/SSZJPZ_11.3.0/com.ibm.swg.im.iis.ds.parjob.adref.doc/topics/r_deeadvrf_ASCII_and_EBCDIC_Conversion_Tables.html       *
*                                                                                                                                                                             *
*                                                                                                                                                                             *
*******************************************************************************************************************************************************************************/
...
char ASCIItoEBCDIC(unsigned char c)
{
        return a2e[c];
}

char EBCDICtoASCII(unsigned char c)
{
        return e2a[c];
}
